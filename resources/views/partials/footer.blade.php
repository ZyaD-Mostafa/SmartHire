            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item me-3">
                        <a href="https://www.facebook.com/profile.php?id=61572470108421" class="text-light" target="_blank">
                            <img src="{{asset('assets/IMG/facebook-logo-24.png')}}" alt="Facebook" width="24" height="24">
                        </a>
                    </li>
                    <li class="list-inline-item me-3">
                        <a href="https://x.com/SmartHire579822" class="text-light" target="_blank">
                            <img src="{{asset('assets/IMG/twitter-logo-24.png')}}" alt="Twitter" width="24" height="24">
                        </a>
                    </li>
                    <li class="list-inline-item me-3">
                        <a href="https://www.linkedin.com/in/smart-hire-hire-aaa47a34a/" class="text-light" target="_blank">
                            <img src="{{asset('assets/IMG/linkedin-logo-24.png')}}" alt="LinkedIn" width="24" height="24">
                        </a>
                    </li>
                    <li class="list-inline-item">
                        <a href="https://www.youtube.com/@Smart-Hire-c6q" class="text-light" target="_blank">
                            <img src="{{asset('assets/IMG/youtube-logo-24.png')}}" alt="YouTube" width="24" height="24">
                        </a>
                    </li>
                </ul>
            </div>
